...
table inet my_table {
    ...
    chain my_input {
        ...
        tcp dport {http, https, 444,445,5700,6688,17840,8080,22,7844,37046,8443,8444} counter accept
        udp dport {http, https, 444,445,5700,6688,17840,8080,22,7844,37046,8443,8444} counter accept
