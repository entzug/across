...
table inet my_table {
    ...
    chain my_input {
        ...
        tcp dport {http, https, 5700,6688,3001,17840,8080,19098,22,7844,37046,8443} counter accept
        udp dport {http, https, 5700,6688,3001,17840,8080,19098,22,7844,37046,8443} counter accept
