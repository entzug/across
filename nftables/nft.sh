...
table inet my_table {
    ...
    chain my_input {
        ...
        tcp dport {http, https, 5700,6688,3001,17840,8080,995,993,465,22} counter accept
        udp dport {http, https, 5700,6688,3001,17840,8080,995,993,465,22} counter accept
